...
#
#	--- This is version is for the CCSM3.0 SRES A1B
#
# ======================================================================
...
PRE2="sresa1b%29%40%40/%28ipcc4/sresa1b/ncar_ccsm3_0%29%40%40/"
PRE3=".pcmdi.ipcc4.ncar_ccsm3_0.sresa1b.run1.atm.mo.xml/."
...
#	wget $PRE1$PRE2$PRE3${VARS[i]}$POST1$POST2
  ...
  rm data$EXT
	...
	# move to nobackup/
	mv ${VARS[i]}$EXT ~/nobackup/data/ccsm3-a1b/
