...
% My modifications (05/23)
%map = [0 0 0; 0.4709 0 0.018; 0 0.3557 0.6747; 0.5422 0.1356 0.8525;
%       0.4688 0.6753 0.3057; 1 0.6893 0.0934; 1 1 0; 1 1 1];

% My modifications (05/27)
map = [0 0 0; 0.4709 0 0.018; 0 0.3557 0.6747; 0.8422 0.1356 0.8525;
       0.4688 0.6753 0.3057; 1 0.6893 0.0934; 1 1 0; 1 1 1];
